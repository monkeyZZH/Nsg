...
public class CartAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            holder.name = (TextView) convertView.findViewById(R.id.cart_itam_name);
            holder.price = (TextView)convertView.findViewById(R.id.cart_itam_price);
            holder.image = (ImageView)convertView.findViewById(R.id.cart_itam_image);
